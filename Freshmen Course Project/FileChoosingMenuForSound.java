...
public class FileChoosingMenuForSound extends JFrame implements ActionListener
{
    ...
    public FileChoosingMenuForSound()
    {
		...
		setLocation(400,400);
            ...
            Intro2 = new JLabel("SoundTrack Name:");
            Intro3 = new JLabel("SoundTrack's URL:");
    ...
    public void actionPerformed(ActionEvent e)
    {
         ...
         if(e.getSource()==FromUrl)
        {
            ...
            Thread down = new Thread(new DownloadThread2(FileName.getText(),URL.getText()));
            down.start();
